...
import os
import ahocorasick  # ac自动机算法:https://github.com/WojciechMula/pyahocorasick
...
class QuestionClassifier:
    def __init__(self):
        ...
        self.region_words = set(self.department_wds + self.disease_wds + self.check_wds + self.drug_wds + self.food_wds
                                + self.producer_wds + self.symptom_wds)  # set()函数创建一个无序不重复元素集
    ...
    def classify(self, question) -> dict:
        data = {}
    ...
    def build_wdtype_dict(self) -> dict:
        wd_dict = dict()  # 创建一个字典wd_dict
    ...
    def build_actree(self, wordlist):
        actree = ahocorasick.Automaton()  # AC自动机算法：用于在输入的一串字符串中匹配有限组“字典”中的子串。
